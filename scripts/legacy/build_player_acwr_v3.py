...
con.execute("""
CREATE OR REPLACE TABLE player_acwr_v3 AS
SELECT
    *,
    CASE 
        WHEN minutes_last_28d >= 180
             AND (minutes_last_28d - minutes_last_7d) >= 90
...
print("Rows:", con.execute("SELECT COUNT(*) FROM player_acwr_v3").fetchall())
...
print("Valid ACWR share:", con.execute("""
